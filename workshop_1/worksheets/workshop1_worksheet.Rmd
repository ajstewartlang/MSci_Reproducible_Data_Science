...
The `guides(colour = FALSE)` call supresses displaying the colour legend - put the hash symbol `#` in front of that line of code and rerun the code chunk to see what changes.
